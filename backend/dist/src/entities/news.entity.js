...
const notify_entity_1 = require("./notify.entity");
...
__decorate([
    (0, typeorm_1.ManyToMany)(() => user_entity_1.User, (user) => user.newsLikes, {
        onDelete: 'CASCADE',
    }),
...
__decorate([
    (0, typeorm_1.ManyToMany)(() => user_entity_1.User, (user) => user.saves, {
        onDelete: 'CASCADE',
    }),
    (0, typeorm_1.JoinTable)({
...
__decorate([
    (0, typeorm_1.ManyToMany)(() => hashTag_entity_1.HashTag, (hashTag) => hashTag.news, {
        onDelete: 'CASCADE',
        eager: true,
    }),
    (0, typeorm_1.JoinTable)({
...
__decorate([
    (0, typeorm_1.OneToMany)(() => comment_entity_1.Comment, (comment) => comment.news, {
        onDelete: 'CASCADE',
    }),
    __metadata("design:type", Array)
], News.prototype, "comments", void 0);
__decorate([
    (0, typeorm_1.OneToMany)(() => notify_entity_1.Notify, (notify) => notify.news, {
        onDelete: 'CASCADE',
    }),
    __metadata("design:type", Array)
