...
class HashTagService {
    ...
    checkIdAndHashTagId(id, hashTagId) {
        return __awaiter(this, void 0, void 0, function* () {
            const self = yield user_service_1.userService.getById(id);
            const hashTag = yield this.getById(hashTagId);
            if (!self || !hashTag)
                return;
            return {
                user: self,
    ...
    update(data) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const newHashTag = yield this.hashTagRepository.save(Object.assign(Object.assign({}, hashTag), { name: data.name || hashTag.name, description: data.description || hashTag.description, slug: data.slug || hashTag.slug }));
                return newHashTag;
            }
            catch (error) {
                throw new Error(error);
    ...
    follow(id, hashTagId) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                (_a = user.hashTags) === null || _a === void 0 ? void 0 : _a.push(hashTag);
                const newUser = (yield user_service_1.userService.updateAll(id, user));
                // add id into users of HashTag
                (_b = hashTag.users) === null || _b === void 0 ? void 0 : _b.push(newUser);
    ...
    unfollow(id, hashTagId) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                // check hash tags of user include hash tag id
                if (!this.checkFollows(user.hashTags, hashTagId))
                    throw new Error(`'${user.username}' is not following ${hashTag.name} to unfollow.`);
                if (!this.checkFollows(hashTag.users, id))
                    throw new Error(`'${hashTag.name}' doesn't have follower '${user.username}'.`);
                ...
                if (typeof idx === 'number' && idx >= 0) {
                    ...
                    yield user_service_1.userService.updateAll(id, user);
                }
