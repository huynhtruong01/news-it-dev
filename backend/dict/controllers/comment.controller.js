...
class CommentController {
    ...
    createComment(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const comment = yield services_1.commentService.create(req.body, req === null || req === void 0 ? void 0 : req.user);
                res.status(enums_1.StatusCode.SUCCESS).json({
                    results: enums_1.Results.SUCCESS,
                    status: enums_1.StatusText.SUCCESS,
                    data: {
    ...
    replyComment(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const comment = yield services_1.commentService.reply(req.body, req.user);
                if (!comment) {
    ...
    likeComment(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const comment = yield services_1.commentService.like(Number(req.params.commentId), req.user);
                if (!comment) {
                    res.status(enums_1.StatusCode.NOT_FOUND).json({
                        results: enums_1.Results.ERROR,
                        status: enums_1.StatusText.FAILED,
    ...
    unlikeComment(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const comment = yield services_1.commentService.unlike(Number(req.params.commentId), req.user);
                if (!comment) {
                    res.status(enums_1.StatusCode.NOT_FOUND).json({
                        results: enums_1.Results.ERROR,
                        status: enums_1.StatusText.FAILED,
