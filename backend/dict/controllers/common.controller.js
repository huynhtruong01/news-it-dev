...
exports.commonController = exports.CommonController = void 0;
const enums_1 = require("../enums");
const services_1 = require("../services");
class CommonController {
    statisticalNumsDashboard(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const statisticalNums = yield services_1.commonService.statisticalDashboard();
...
exports.commonController = new CommonController();
