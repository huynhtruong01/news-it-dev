...
const sendEmail = (to, url, text, message = `Chúc mừng! Bạn gần như đã sẵn sàng để bắt đầu sử dụng Web Tin tức.
    Chỉ cần nhấp vào nút bên dưới để xác thực địa chỉ email của bạn.`) => __awaiter(void 0, void 0, void 0, function* () {
